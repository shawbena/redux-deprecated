...
(function (VisibilityFilters) {
    ...
    VisibilityFilters[VisibilityFilters["SHOW_COMPUTED"] = 1] = "SHOW_COMPUTED";
...
var reducers_1 = __importDefault(__webpack_require__(25));
...
store.dispatch(actions_1.addTodo('Learn about actions'));
store.dispatch(actions_1.addTodo('Learn about reducers'));
store.dispatch(actions_1.addTodo('Learn about store'));
store.dispatch(actions_1.toggleTodo(0));
store.dispatch(actions_1.toggleTodo(1));
store.dispatch(actions_1.setVisibiltyFilter(actions_2.VisibilityFilters.SHOW_COMPUTED));
unsubscribe();
...
Object.defineProperty(exports, "__esModule", { value: true });
var actionTypes_1 = __webpack_require__(9);
/*
* action creators
*/
