...
(function (ActionTypes) {
    ActionTypes[ActionTypes["ADD_TODO"] = 0] = "ADD_TODO";
    ActionTypes[ActionTypes["TOGGLE_TODO"] = 1] = "TOGGLE_TODO";
    ActionTypes[ActionTypes["SET_VISIBILITY_FILTER"] = 2] = "SET_VISIBILITY_FILTER";
...
})(VisibilityFilters = exports.VisibilityFilters || (exports.VisibilityFilters = {}));
...
var reducers_1 = __importDefault(__webpack_require__(68));
var components_1 = __importDefault(__webpack_require__(70));
...
react_dom_1.render(react_1.default.createElement(react_redux_1.Provider, { store: store },
    react_1.default.createElement(components_1.default, null)), div);
...
var m=__webpack_require__(4),n=__webpack_require__(7),p=__webpack_require__(2),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.portal"):60106,u=q?Symbol["for"]("react.fragment"):60107,v=q?Symbol["for"]("react.strict_mode"):60108,w=q?Symbol["for"]("react.provider"):60109,x=q?Symbol["for"]("react.context"):60110,y=q?Symbol["for"]("react.async_mode"):60111,z=q?Symbol["for"]("react.forward_ref"):60112,A="function"===
...
*/
var ba=__webpack_require__(1),m=__webpack_require__(15),A=__webpack_require__(4),C=__webpack_require__(2),ea=__webpack_require__(16),fa=__webpack_require__(17),ha=__webpack_require__(18),ja=__webpack_require__(7);
...
function visibilityFilter(state, action) {
    ...
    switch (action.type) {
        case actions_1.ActionTypes.SET_VISIBILITY_FILTER:
...
function todos(state, action) {
    ...
    switch (action.type) {
        case actions_1.ActionTypes.ADD_TODO:
            return state.concat([
                {
                    id: action.id,
                    text: action.text,
        ...
        case actions_1.ActionTypes.TOGGLE_TODO:
            return state.map(function (todo, index) {
                if (index === action.index) {
                    return __assign({}, todo, { text: todo.text, completed: !todo.completed });
                }
                return todo;
            });
        default:
...
Object.defineProperty(exports, "__esModule", { value: true });
var actionTypes_1 = __webpack_require__(28);
/*
* action creators
*/
function addTodo(text) {
    return { type: actionTypes_1.ActionTypes.ADD_TODO, text: text };
}
exports.addTodo = addTodo;
function toggleTodo(index) {
    return { type: actionTypes_1.ActionTypes.TOGGLE_TODO, index: index };
}
exports.toggleTodo = toggleTodo;
// change filter to it's type
function setVisibiltyFilter(filter) {
    return { type: actionTypes_1.ActionTypes.SET_VISIBILITY_FILTER, filter: filter };
}
exports.setVisibiltyFilter = setVisibiltyFilter;
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importDefault(__webpack_require__(1));
var footer_1 = __importDefault(__webpack_require__(71));
var visible_todo_list_1 = __importDefault(__webpack_require__(74));
var add_todo_1 = __importDefault(__webpack_require__(77));
var App = function () { return (react_1.default.createElement("div", null,
    react_1.default.createElement(add_todo_1.default, null),
    react_1.default.createElement(visible_todo_list_1.default, null),
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importDefault(__webpack_require__(1));
var filter_link_1 = __importDefault(__webpack_require__(72));
var actions_1 = __webpack_require__(3);
var Footer = function () { return (react_1.default.createElement("p", null,
    "Show:",
    ' ',
    react_1.default.createElement(filter_link_1.default, { filter: actions_1.VisibilityFilters.SHOW_ALL }, "All"),
    ' ',
    react_1.default.createElement(filter_link_1.default, { filter: actions_1.VisibilityFilters.SHOW_ACTIVE }, "Active"),
    ', ',
    react_1.default.createElement(filter_link_1.default, { filter: actions_1.VisibilityFilters.SHOW_COMPLETED }, "Completed"))); };
...
var react_redux_1 = __webpack_require__(9);
var actions_1 = __webpack_require__(3);
var link_1 = __importDefault(__webpack_require__(73));
...
var mapDispatchToProps = function (dispatch, ownProps) {
    return {
        onClick: function () {
            dispatch(actions_1.setVisibiltyFilter(ownProps.filter));
        }
    };
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importDefault(__webpack_require__(1));
var prop_types_1 = __importDefault(__webpack_require__(6));
var Link = function (_a) {
    ...
    return (react_1.default.createElement("a", { href: "", onClick: function (e) {
            e.preventDefault();
            onClick();
        } }, children));
};
...
var react_redux_1 = __webpack_require__(9);
var actions_1 = __webpack_require__(3);
var actions_2 = __webpack_require__(3);
var todo_list_1 = __importDefault(__webpack_require__(75));
...
var mapDispatchToProps = function (dispatch) {
    return {
        onTodoClick: function (id) {
            dispatch(actions_2.toggleTodo(id));
        }
    };
};
var VisibleTodoList = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(todo_list_1.default);
...
var react_1 = __importDefault(__webpack_require__(1));
var prop_types_1 = __importDefault(__webpack_require__(6));
var todo_1 = __importDefault(__webpack_require__(76));
var TodoList = function (_a) {
    var todos = _a.todos, onTodoClick = _a.onTodoClick;
    return (react_1.default.createElement("ul", null, todos.map(function (todo, index) { return (react_1.default.createElement(todo_1.default, __assign({ key: index }, todo, { onClick: function () { return onTodoClick(index); } }))); })));
};
TodoList.propTypes = {
    todos: prop_types_1.default.arrayOf(prop_types_1.default.shape({
        id: prop_types_1.default.number.isRequired,
        completed: prop_types_1.default.bool.isRequired,
        text: prop_types_1.default.string.isRequired
    }).isRequired),
    onTodoClick: prop_types_1.default.func.isRequired
};
...
var Todo = function (_a) {
    ...
    return (react_1.default.createElement("li", { onClick: onClick, style: {
...
var AddTodo = function (_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("form", { onSubmit: function (e) {
            ...
            react_1.default.createElement("input", { type: "text", ref: function (node) { return input = node; } }),
            react_1.default.createElement("button", { type: "submit" }, "Add AddTodo"))));
};
// AddTodo = connect()(AddTodo);
var AddTodoWrapper = react_redux_1.connect()(AddTodo);
exports.default = AddTodoWrapper;
